package com.javaEdu.Iterable_Iterator_ListIterator;
...
public class IteratorDemo {
    ...
    public static void IteratorDemoMain(){
...
//        System.out.println("========== Iterator - Concurrent Modification error ");
//        iterator = integers.iterator();
//        while (iterator.hasNext()){
//            integers.remove(0);
...
//        }
        ...
        System.out.println("======== Iterator - weakly consistent iteator  demo");
